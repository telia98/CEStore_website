...
public class BlobTesterVestiario {
	...
	public static void main(String[] args) {
		...
		try {
			...
			for(int i=1;i<220;i++) {
				String sql="UPDATE vestiario SET linkFoto1=?,linkFoto2=? WHERE codCapo=?";
				...
				String cartella1="vestiario/link1/";
				String cartella2="vestiario/link2/";
			...
			String sql="UPDATE vestiario SET linkFoto3=? WHERE codCapo=?";
			
			PreparedStatement pstmt = con.prepareStatement(sql);
		
			// read the file
			String cartella3="vestiario/link3/";
